...
public class ShareHelper {
    ...
    public void shareToWeiXin(Activity context) {
        ...
        Bitmap bt = BitmapFactory.decodeResource(context.getResources(), R.drawable.logo); // TODO
    ...
    // 分享到朋友圈
    public void shareToWeiXinCircle(Activity context) {
        Intent intent = new Intent(Intent.ACTION_SEND); // 地址
        ComponentName componentName = new ComponentName(
                "com.tencent.mm",
...
//        }
        //将项目图片转换为uri
        BitmapDrawable bd = (BitmapDrawable) context.getResources().getDrawable(R.drawable.logo);
